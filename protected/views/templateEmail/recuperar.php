                                                ...
                                                <td width="517" style="font-size:12px" valign="top" align="left">
                                                    ...
                                                    <div style="margin-bottom:10px;font-size:16px;color:#999"> 
                                                        ...
                                                        <a href="#" style="color:#ff4629;text-decoration:none;font-size:17px;font-weight:bold">
                                                            <?php echo ucfirst($recuperar->usuario->nombre) ?>
                                                        </a>,
                                                        <br/>solicitud de recuperación de  contraseña:
                                                    </div>
                                                    <div >
                                                        ...
                                                        <div style="font-size:16px;color:#999;margin-left: 20px;margin-top: 10px">                                                                       
                                                             Este email ha sido enviado para ayudarlo a recuperar su contraseña.<br/>
                                                             Por favor, haga un click en el  enlace de a continuación.
                                                        </div>                                                        
                                                    </div>
                                                    <br/>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding:5px 15px;background-color:#ff4629;">                                                                    
                                                                    <a href="<?php echo Yii::app()->createAbsoluteUrl('usuarios/cambiar', array('key' => $recuperar->key))?>" style="color:#fff;font-size:13px;font-weight:bold;text-decoration:none" target="_blank">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="background-color:#d9edf7;border:1px solid #31708f;color:#31708f;padding:10px;font-size:11px">
                                                        ...
                                                        <a href="<?php echo Yii::app()->createAbsoluteUrl('usuarios/cambiar', array('key' => $recuperar->key)) ?>" style="color:#3b5998;text-decoration:none" target="_blank">
                                                            <?php echo Yii::app()->createAbsoluteUrl('usuarios/cambiar', array('key' => $recuperar->key)) ?> 
                                                        </a>
                                                    </td>
                                                </tr>
                                            </tbody>
