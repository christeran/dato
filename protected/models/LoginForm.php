...
class LoginForm extends CFormModel
{
	...
	{
		return array(
			'username'=>Yii::t('login','Usuario'),
			'password'=>Yii::t('login','Contraseña'),
	...
	public function authenticate($attribute,$params)
	{
		if(!$this->hasErrors())
		{
			...
			if($this->_identity->authenticate()==1)
                            ...
                            $this->addError('username','El usuario no se encuentra activo, porfavor activelo usando el link en tu email');
		}
	}
